...
from pyleecan.GUI.Dialog.DMachineSetup.SMHoleMag.PHoleM65.Gen_PHoleM65 import (
    Gen_PHoleM65,
)
...
class PHoleM65(Gen_PHoleM65, QWidget):
    ...
    def __init__(self, hole=None, material_dict=None):
        ...
        if hole.magnet_0 is None:  # SyRM
            self.img_slot.setPixmap(QPixmap(pixmap_dict["HoleM65_empty_int_rotor"]))
        ...
        self.lf_R.setValue(self.hole.R)
        ...
        self.lf_R.editingFinished.connect(self.set_R)
    ...
    def set_R(self):
        """Signal to update the value of R according to the line edit
