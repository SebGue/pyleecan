...
from pyleecan.GUI.Dialog.DMachineSetup.SMHoleMag.PHoleM64.Gen_PHoleM64 import (
    Gen_PHoleM64,
)
...
class PHoleM64(Gen_PHoleM64, QWidget):
    """Page to set the Hole Type 64"""

    # Signal to DMachineSetup to know that the save popup is needed
    saveNeeded = Signal()
    # Information for WHoleMag
    hole_name = "Hole Type 64"
    hole_type = HoleM64
    ...
    def __init__(self, hole=None, material_dict=None):
        ...
        if hole.magnet_0 is None:  # SyRM
            self.img_slot.setPixmap(QPixmap(pixmap_dict["HoleM64_empty_int_rotor"]))
