...
def non_linear_model(size_x, size_y, x, y, pos,geometry, sol0,BC,la,mu0,Br):
    ...
    for i in range(1, permeability_materials.size+1):
        M_csr = assembly_one_area(i, reluc_list,list_geometry, Num_Unknowns, list_elem, permeability_cell,BC_list)
    ...
    while criteria > eps and i < 500:
        ...
        for i in non_linear_area:
            Matrix=assembly_one_area(i, reluc_list,list_geometry, Num_Unknowns, list_elem, permeability_cell,BC_list)
            M_non_lin += Matrix
