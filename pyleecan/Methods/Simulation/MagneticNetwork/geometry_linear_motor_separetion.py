...
@author: LAP02
"""
from pre_processing import save_mesh,init_reluc,init_point,init_cell,init_permeabilty_cell,init_permeabilty_cell,init_mesh_BC
...
list_geometry_rotor,permeability_materials_rotor,reatach_rotor= geometry(size_x,size_y, 1) 
...
Num_Unknowns_rotor=numeroting_unknows(list_elem_rotor,BC_list_rotor,Periodic_point_rotor,reatach_rotor)

permeability_cell_rotor=init_permeabilty_cell(size_x,size_y_rotor,permeability_materials,list_geometry_rotor)



reluc_list_rotor=init_reluc(list_elem_rotor,list_coord_rotor,mu0,la,mode)
M_csr_rotor = assembly(reluc_list_rotor, Num_Unknowns_rotor, list_elem_rotor, permeability_cell_rotor,BC_list_rotor)
...
list_geometry_stator,permeability_materials_stator,reatach_stator= geometry2(size_x,size_y, 1) 
...
Num_Unknowns_stator=numeroting_unknows(list_elem_stator,BC_list_stator,Periodic_point_stator,reatach_stator)
permeability_cell_stator=init_permeabilty_cell(size_x,size_y_stator,permeability_materials,list_geometry_stator)


reluc_list_stator=init_reluc(list_elem_stator,list_coord_stator,mu0,la,mode)
M_csr_stator = assembly(reluc_list_stator, Num_Unknowns_stator, list_elem_stator, permeability_cell_stator,BC_list_stator)
