...
sol0=None
F, list_geometry, Num_unknowns, list_elem, permeability_cell,list_coord = non_linear_model(size_x, size_y, x, y, pos,geometry, sol0,BC,la,mu0,Br)
...
mesh = meshio.Mesh(
    ...
    cell_data={"B": [B],"Materials":[list_geometry],"Permeability":[permeability_cell]},
)
mesh.write(
