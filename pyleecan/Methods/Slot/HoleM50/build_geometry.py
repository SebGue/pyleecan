...
def build_geometry(self, alpha=0, delta=0, is_simplified=False):
    ...
    L_3_4 = Segment(Z3, Z4, prop_dict={BND_LAB: "_".join([RMAG, RIGHT_LAB, "0"])})
    L_3s_2s = Segment(Z3s, Z2s, prop_dict=None)
    L_3s_4s = Segment(Z3s, Z4s, prop_dict={BND_LAB: "_".join([RMAG, LEFT_LAB, "1"])})
    L_3_8c = Segment(Z3, Z8c, prop_dict={BND_LAB: "_".join([RHOLE, RIGHT_LAB, "0"])})
    L_3s_8cs = Segment(Z3s, Z8cs, prop_dict={BND_LAB: "_".join([RHOLE, LEFT_LAB, "1"])})
    L_4_5 = Segment(Z4, Z5, prop_dict={BND_LAB: "_".join([RMAG, BOT_LAB, "0"])})
    L_4s_3s = Segment(Z4s, Z3s, prop_dict=None)
    L_4s_5s = Segment(Z4s, Z5s, prop_dict={BND_LAB: "_".join([RMAG, BOT_LAB, "1"])})
    L_5_6 = Segment(Z5, Z6, prop_dict={BND_LAB: "_".join([RMAG, LEFT_LAB, "0"])})
    L_5s_4s = Segment(Z5s, Z4s, prop_dict=None)
    L_5s_6s = Segment(Z5s, Z6s, prop_dict={BND_LAB: "_".join([RMAG, RIGHT_LAB, "1"])})
    ...
    L_8b_6 = Segment(Z8b, Z6, prop_dict={BND_LAB: "_".join([RHOLE, LEFT_LAB, "0"])})
    L_8bs_6s = Segment(
        Z8bs, Z6s, prop_dict={BND_LAB: "_".join([RHOLE, RIGHT_LAB, "1"])}
    )
    ...
    L_8c_9 = Segment(Z8c, Z9, prop_dict={BND_LAB: "_".join([RHOLE, TOP_LAB, "0"])})
    L_8cs_9s = Segment(Z8cs, Z9s, prop_dict={BND_LAB: "_".join([RHOLE, TOP_LAB, "1"])})
