...
def draw_GMSH(
    ...
    if not is_lam_only_S:
        for surf in rotor_list:
            ...
            # Draw the surface
            draw_surf_line(
                surf, mesh_list, boundary_prop, model, gmsh_dict, nsurf, mesh_size_R
            )
    ...
    if not is_lam_only_R:
        ...
        for surf in stator_list:
            ...
            # Draw the surface
            draw_surf_line(
                surf, mesh_list, boundary_prop, model, gmsh_dict, nsurf, mesh_size_S
            )
    ...
    for surf in ab_list:
        ...
        # Draw the surface
        draw_surf_line(
            surf, mesh_list, boundary_prop, model, gmsh_dict, nsurf, mesh_size_AB
        )
