...
try:
    from ..Methods.Slot.HoleM50.get_height_magnet_id import get_height_magnet_id
except ImportError as error:
...
class HoleM50(HoleMag):
    ...
    # cf Methods.Slot.HoleM50.get_height_magnet_id
    if isinstance(get_height_magnet_id, ImportError):
        get_height_magnet_id = property(
            fget=lambda x: raise_(
                ImportError(
                    "Can't use HoleM50 method get_height_magnet_id: "
