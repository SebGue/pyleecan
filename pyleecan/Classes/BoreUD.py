...
class BoreUD(Bore):
    ...
    def __init__(self, line_list=-1, sym=1, type_merge_slot=1, init_dict = None, init_str = None):
    ...
    def copy(self):
        ...
        obj_copy = type(self)(line_list=line_list_val,sym=sym_val,type_merge_slot=type_merge_slot_val)
        return obj_copy
