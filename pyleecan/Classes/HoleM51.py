...
try:
    from ..Methods.Slot.HoleM51.get_height_magnet_id import get_height_magnet_id
except ImportError as error:
...
class HoleM51(HoleMag):
    ...
    # cf Methods.Slot.HoleM51.get_height_magnet_id
    if isinstance(get_height_magnet_id, ImportError):
        get_height_magnet_id = property(
            fget=lambda x: raise_(
                ImportError(
                    "Can't use HoleM51 method get_height_magnet_id: "
