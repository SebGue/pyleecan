...
class SlotCirc(Slot):
    ...
    def __init__(self, W0=0.01, H0=0.03, Zs=36, wedge_mat=None, is_bore=True, init_dict = None, init_str = None):
    ...
    def copy(self):
        ...
        obj_copy = type(self)(W0=W0_val,H0=H0_val,Zs=Zs_val,wedge_mat=wedge_mat_val,is_bore=is_bore_val)
        return obj_copy
