...
class LossModelSteinmetz(LossModel):
    ...
    def __init__(self, k_hy=None, k_ed=None, alpha_f=None, alpha_B=None, name="", init_dict = None, init_str = None):
    ...
    def copy(self):
        ...
        obj_copy = type(self)(k_hy=k_hy_val,k_ed=k_ed_val,alpha_f=alpha_f_val,alpha_B=alpha_B_val,name=name_val)
        return obj_copy
