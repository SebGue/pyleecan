...
class BoreLSRPM(Bore):
    ...
    def __init__(self, N=8, Rarc=0.0375, W1=0.0035, alpha=0, type_merge_slot=1, init_dict = None, init_str = None):
    ...
    def copy(self):
        ...
        obj_copy = type(self)(N=N_val,Rarc=Rarc_val,W1=W1_val,alpha=alpha_val,type_merge_slot=type_merge_slot_val)
        return obj_copy
