...
def test_FEMM_Loss_Prius():
    ...
    for i, out in enumerate(xout):
        if not exists(
            rf"C:\Users\LAP10\Documents\Loss\plot_B_mesh\Id={OP_MATRIX[i,1]}, Iq={OP_MATRIX[i,2]}.gif"
        ):
            out.plot_B_mesh(
                is_animated=True,
                save_path=rf"C:\Users\LAP10\Documents\Loss\plot_B_mesh\Id={OP_MATRIX[i,1]}, Iq={OP_MATRIX[i,2]}.gif",
            )
        out.plot_B_mesh()
        power_dict = {
